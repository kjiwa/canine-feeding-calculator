...
handleBodyWeightChanges(null)
document.getElementById('body-weight-form').addEventListener('submit', handleBodyWeightChanges)
document.getElementById('body-weight-input').addEventListener('keyup', handleBodyWeightChanges)
document.getElementById('body-weight-units-select').addEventListener('change', handleBodyWeightChanges)
